...
/*    private void Align_Body()
    ...
    private static Vector3 GetVector3FromScene(Kinect.Joint joint, GameObject bodyObject)
    {
        return new Vector3(-joint.Position.X + bodyObject.transform.position.x, joint.Position.Y + bodyObject.transform.position.y, joint.Position.Z + bodyObject.transform.position.z);
    }
}
