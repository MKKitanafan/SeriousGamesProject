...
public class DetectGrabRight : MonoBehaviour {
    ...
    private void HandInFist(Kinect.JointType jt, Kinect.Body body)
    {
        ...
        jt2 = Kinect.JointType.HandTipRight;
        ...
        rightGrabOld = GrabChange(rightGrabOld, rightGrab, countdownRight);
        bodyAnim.SetBool("RightFist", rightGrabOld);
    }
